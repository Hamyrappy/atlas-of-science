...
2. `docs/architecture.md` — the metamodel, the step model, the store, provenance end to end.
3. `atlas/model/` — the six types everything else exchanges. Read the files themselves; nothing here restates them.
